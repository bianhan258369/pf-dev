...
public class ClientService {
    ...
    private List<ProblemDiagram> subProblemDiagrams = new LinkedList<>();
    private List<ClockDiagram> clockDiagrams = new LinkedList<>();
    private List<ScenarioDiagram> scenarioDiagrams = new LinkedList<>();
    private ProblemDiagram myProblemDiagram;

    public void loadProjectXML(String path) throws DocumentException {
